        ...
        <div class="w-full background  lg:max-w-[250px] 2xl:min-w-[350px]  rounded-lg border border-gray-400 ">
          <div class="flex justify-center pl-3 pt-2">
            <div class="flex   ">
             ...
             <div>
              <h5 class=" text-left text-base font-akira font-bold  text-white ">
                JOHN 
              </h5>
              <span class="text-3xl font-akira font-black text-white">
                PETER
              </span>
           ...
           <div className="flex gap-1 mt-[-40px]  items-center font-['lexend']">
                    <div className="ml-2 mb-3 bg-gradient-to-b from-[#3e3e3e]/40 to-[#000000]/40 rounded-lg w-13 h-13 2xl:w-16 2xl:h-16">
