      ...
      <div className="flex-col w-full">
        ...
        <div className="flex  divide-x  ">
          ...
          <div className="mr-10 ">
            ...
            <div className="flex    ml-8">
              ...
              <div className="ml-1">
                <a
                 href="/traningdrill/uploaddrills"
                  class="inline-flex font-dm items-center py-2 px-5 ml-2 text-base font-medium text-white bg-green-500 rounded-[4px] mt-8 "
                >
                  Upload Drill
                </a>
              </div>
            ...
            <div class="overflow-x-auto relative mx-10">
              <table class="w-full text-base text-left  text-gray-400 ">
                <thead class="text-sm font-dm text-white/43   border-b border-grey-400">
                  <tr className="text-center font-dm">
                    ...
                    <th scope="col" class="py-3 px-7"></th>
                  </tr>
                </thead>
                <tbody>
                  {staticdata.map((val, ind) => (
                    <tr class=" border-b text-white/1 font-lexend border-gray-400 text-center">
                      <th
                        scope="row"
                        class="py-4 px-7 font-light text-sm text-white whitespace-nowrap "
                      >
                        {ind + 1}
                      </th>
                      <td class="py-4 px-7">
                      ...
                      <td class="py-4 px-7">Passing</td>
                      <td class="py-4 px-7">20-Aug-22</td>
                      <td class="py-4 px-7">2.00</td>
                      <td class="py-4 px-7">mp4</td>
                      <td class="py-4 px-7 ">
          ...
          <div className="">
            ...
            <div className="mx-20 mt-10 2xl:grid 2xl:grid-cols-2 2xl:gap-x-20">
              {staticdata.map((val, ind) => {
                return <DrillCard />;
              })}
            </div>
